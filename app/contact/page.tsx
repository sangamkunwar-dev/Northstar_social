  ...
  return (
    <main className="min-h-screen bg-background px-6 py-8 text-foreground">
      <header className="mx-auto flex max-w-6xl items-center justify-between">
        <Link href="/" className="text-lg font-semibold">Northstar Social</Link>
      ...
      <section className="mx-auto max-w-2xl py-24">
        ...
        <p className="mt-6 text-lg leading-8 text-muted-foreground">Have a question, idea, or feedback about Northstar Social? I&apos;d love to hear from you.</p>
