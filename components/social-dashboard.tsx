...
export function SocialDashboard() {
  ...
  const [tab, setTab] = useState<'overview' | 'create' | 'history' | 'analytics' | 'integrations' | 'support'>('overview')
...
function Brand() { return <div className="flex items-center gap-3"><div className="grid size-9 place-items-center rounded-xl bg-primary text-primary-foreground"><Sparkles size={18}/></div><span className="text-lg font-semibold">नर्थस्टार सिर्जनालय <span className="text-xs font-medium text-muted-foreground">Northstar Social</span></span></div> }
